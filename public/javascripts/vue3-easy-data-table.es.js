...
var ButtonsPagination = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-e19862d2"]]);
...
const _withScopeId = (n) => (pushScopeId("data-v-1c6cf8e2"), n = n(), popScopeId(), n);
const _hoisted_1 = ["id"];
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose, emit: emits }) {
    const props = __props;
    useCssVars((_ctx) => ({
      "e3920df2": unref(tableMinHeightPx),
      "59ea6f6e": unref(tableHeightPx)
    }));
    const {
      tableNodeId,
      clickEventType,
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        !_ctx.hideFooter ? (openBlock(), createElementBlock("div", _hoisted_12, [
          ...
          createElementVNode("div", _hoisted_14, toDisplayString(`${unref(currentPageFirstIndex).toLocaleString()}\u2013${unref(currentPageLastIndex).toLocaleString()}`) + " " + toDisplayString(unref(rowsOfPageSeparatorMessage).toLocaleString()) + " " + toDisplayString(unref(totalItemsLength).toLocaleString()), 1),
...
var DataTable = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1c6cf8e2"]]);
