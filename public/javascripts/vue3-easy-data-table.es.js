...
const _hoisted_2$6 = /* @__PURE__ */ _withScopeId$5(() => /* @__PURE__ */ createElementVNode("label", { for: "checbox" }, null, -1));
...
const _sfc_main$2 = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const paginationItemsForRender = computed(() => {
      ...
      } else if ([1, 2, props.maxPaginationNumber, props.maxPaginationNumber - 1].includes(props.currentPaginationNumber) || [3, 4].includes(props.currentPaginationNumber)) {
...
var ButtonsPagination = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-7c2cfe23"]]);
...
const _withScopeId = (n) => (pushScopeId("data-v-b8890250"), n = n(), popScopeId(), n);
const _hoisted_1 = ["id"];
...
const _sfc_main = defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    useCssVars((_ctx) => ({
      "25521d7d": tableMinHeightPx.value,
      "752e30da": tableHeightPx.value
    }));
    const props = __props;
    const {
      tableNodeId,
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        !_ctx.hideFooter ? (openBlock(), createElementBlock("div", _hoisted_12, [
          ...
          createElementVNode("div", _hoisted_14, toDisplayString(`${unref(currentPageFirstIndex).toLocaleString()}\u2013${unref(currentPageLastIndex).toLocaleString()}`) + " " + toDisplayString(unref(rowsOfPageSeparatorMessage)) + " " + toDisplayString(unref(totalItemsLength).toLocaleString()), 1),
...
var DataTable = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b8890250"]]);
